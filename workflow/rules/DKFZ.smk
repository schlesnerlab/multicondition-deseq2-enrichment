...
rule rseqc_junction_annotation:
    input:
        bam=join(BASE_DATA_DIR,"{sample}","{tissue}", SEQ_TYPE,
            "merged-alignment", "{tissue}_{sample}_merged.mdup.bam"),
        bed=BASE_ANALYSIS_DIR + "qc/rseqc/annotation.bed"
    output:
...
rule rseqc_junction_saturation:
    input:
        ...
        bed=BASE_ANALYSIS_DIR + "qc/rseqc/annotation.bed"
    output:
        BASE_ANALYSIS_DIR + "qc/rseqc/{sample}@{tissue}.junctionsat.junctionSaturation_plot.pdf"
    priority: 1
    log:
...
rule rseqc_stat:
    input:
        join(BASE_DATA_DIR,"{sample}","{tissue}", SEQ_TYPE,
            "merged-alignment", "{tissue}_{sample}_merged.mdup.bam"),
    output:
...
rule rseqc_innerdis:
    input:
        ...
        bed=BASE_ANALYSIS_DIR + "qc/rseqc/annotation.bed"
    output:
        BASE_ANALYSIS_DIR + "qc/rseqc/{sample}@{tissue}.inner_distance_freq.inner_distance.txt"
    priority: 1
    log:
...
rule multiqc:
    input:
        expand(join(BASE_DATA_DIR,"{unit.sample_unit}","{unit.tissue}", SEQ_TYPE,
            "merged-alignment", "{unit.tissue}_{unit.sample_unit}_merged.mdup.bam"), 
            unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.junctionanno.junction.bed", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.junctionsat.junctionSaturation_plot.pdf", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.infer_experiment.txt", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.stats.txt", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.inner_distance_freq.inner_distance.txt", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.readdistribution.txt", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.readdup.DupRate_plot.pdf", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "qc/rseqc/{unit.sample_unit}@{unit.tissue}.readgc.GC_plot.pdf", unit=units.itertuples()),
        expand(BASE_ANALYSIS_DIR + "logs/rseqc/rseqc_junction_annotation/{unit.sample_unit}@{unit.tissue}.log", unit=units.itertuples()),
