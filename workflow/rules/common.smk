    ...
    for cond in CONTRASTS:
        ...
        output_files.extend(expand(
            [
                ...
                join(BASE_ANALYSIS_DIR, "progeny/{condition}/{contrast}_progeny.html"),
                join(BASE_ANALYSIS_DIR, "dorothea/{condition}/{contrast}_dorothea.html"),
...
def get_gsea_results(wildcards):
    ...
    gsea_files = expand(join(BASE_ANALYSIS_DIR, "results/diffexp/{condition}/{contrast}.gseares.RDS"),
