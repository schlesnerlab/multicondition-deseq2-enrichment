...
if (exists("snakemake")) {
  ...
  BASE_ANALYSIS_DIR <- "/omics/odcf/analysis/OE0228_projects/VascularAging/rna_sequencing/tec_aplnKO"
...
#  contrast_groups <- c("Young-EC_apelin", "Young-EC")
  ...
  samp_map <- "../../data/tumor_vs_ec/Apln_KO.tsv"
  plot_path <- "./"
  the_yaml <- yaml::read_yaml("../../configs/tec_aplnKO.yaml")
