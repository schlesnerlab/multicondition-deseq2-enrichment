...
create_msig_entries(gsea_result, msig_type = "msig_gsea", ktype = gene_name_type, limit = 2)
```
...
create_msig_entries(gsea_result, msig_type = "msig_C3", ktype = gene_name_type)
```
...
create_msig_entries(gsea_result, msig_type = "msig_C6", ktype = gene_name_type)
```
