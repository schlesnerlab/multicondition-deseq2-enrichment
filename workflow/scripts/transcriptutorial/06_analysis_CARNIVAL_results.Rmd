...
if (exists("snakemake")) {
  ...
  BASE_DIR <- "/omics/odcf/analysis/OE0228_projects/VascularAging/rna_sequencing/Vasc_age2020/results/carnival/sample_resolution"
  workflow_config <- yaml::read_yaml("../../configs/VascAge_config.yaml")
  sample_table <- readr::read_tsv("../../data/Vasc_age2020/Vascage_samples.tsv")
...
omniR <- OmnipathR::import_omnipath_interactions(organism = 10090)
...
yoted <- purrr::map2(yoted, names(groups_to_check), function(x, y) x + ggtitle(y))
