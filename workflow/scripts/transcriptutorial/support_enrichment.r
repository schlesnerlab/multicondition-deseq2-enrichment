...
#' Process Carnival object by removing zero weight edges
#'
#' @param carnival_res carnival result object from carnival 2.*
#'
#' @return
#' @export
#'
